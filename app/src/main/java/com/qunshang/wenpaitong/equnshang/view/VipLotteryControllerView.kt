...
import kotlinx.android.synthetic.main.view_controller_vip_lottery.view.layout_brand
import kotlinx.android.synthetic.main.view_controller_vip_lottery.view.layout_lottery
 ...
 */
class VipLotteryControllerView(context: Context?, attrs: AttributeSet?) : RelativeLayout(context, attrs), View.OnClickListener {
    ...
    init {
        val rootView = LayoutInflater.from(context).inflate(R.layout.view_controller_vip_lottery, this)
