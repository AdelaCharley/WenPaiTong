...
import kotlinx.android.synthetic.main.activity_add_address_v2.*
...
class AddAddressActivityV2 : BaseActivity() {
    ...
    fun save(){
        ...
        ApiManager.getInstance().getApiAddress().saveAddress(
            ...
            phone.text.toString(),
            address + "," + detail.text.toString(),default).enqueue(object :
            ...
            override fun onResponse(
                ...
                if (response.body()!= null){
                    ...
                    if (body?.statusCode == 0){
                        DialogUtil.toast(this@AddAddressActivityV2,"上传成功")
                        finish()
                    } else {
                        DialogUtil.toast(this@AddAddressActivityV2,body?.message + "")
                    }
                }
            }
