...
public class SoftUtil {
    ...
    public void attachSoftInput(final View anyView, final ISoftInputChanged listener) {
        ...
        KeyBoardListenerHelper keyBoardListenerHelper = new KeyBoardListenerHelper((Activity) anyView.getContext());
        keyBoardListenerHelper.setOnKeyBoardChangeListener((isShow, keyBoardHeight) -> {
            /*if (isFirst){
                isFirst = false;
                return;
            }*/
            ...
            if (rootHeight - mutableHeight > rect.bottom) {
                ...
                if (SoftUtil.this.softInputHeight != softInputHeight) {
                    softInputHeightChanged = true;
                    SoftUtil.this.softInputHeight = softInputHeight;
                } else {
