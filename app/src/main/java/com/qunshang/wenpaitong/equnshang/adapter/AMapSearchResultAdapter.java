 ...
 * 类说明：
 */
public class AMapSearchResultAdapter extends BaseAdapter {
    ...
    public AMapSearchResultAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.view_holder_amap_result, parent, false);
