...
import com.qunshang.wenpaitong.equnshang.view.ToDayLotteryControllerView;
 ...
 */
public class ToDayLotteryVideoAdapter extends BaseRvAdapter<LotteryVideoBean.DataBean, ToDayLotteryVideoAdapter.LotteryViewHolder> {


    public ToDayLotteryVideoAdapter(Context context, List<LotteryVideoBean.DataBean> datas) {
        super(context, datas);
    }
    ...
    public LotteryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.item_today_lottery_video, parent, false);
        return new LotteryViewHolder(view);
    }

    public class LotteryViewHolder extends BaseRvViewHolder {
        @BindView(R.id.lv_item_video_likeview)
        LikeView likeView;
        @BindView(R.id.cv_item_video_controller)
        ToDayLotteryControllerView controllerView;
