...
import kotlinx.android.synthetic.main.fragment_college_share__two.*
...
class CollegeShare_TwoFragment(val bean : CollegeNewsShareBean) : BaseShareFragment() {
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_college_share__two, container, false)
    }
