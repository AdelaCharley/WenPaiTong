...
public class ManufactureVideoAdapterV2 extends RecyclerView.Adapter<ManufactureVideoAdapterV2.ViewHolder> {
    ...
    public ManufactureVideoAdapterV2(Context context,ArrayList<QiShiTongVideoBean.DataBean> data){
