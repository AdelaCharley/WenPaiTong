...
import kotlinx.android.synthetic.main.activity_modify_address_v2.*
...
class ModifyAddressActivityV2 : BaseActivity (){

    lateinit var bean : AddressBean.DataBean
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_modify_address_v2)
        toolbar_back.setOnClickListener {
            finish()
        }
        toolbar_title.setText("修改收货地址")
        bean = intent.getSerializableExtra("data") as AddressBean.DataBean
        videoname.setText(bean.name)
        phone.setText(bean.phone)

        site.setText(StringUtils.getBriefAddress(bean.site))
        address = StringUtils.getBriefAddress(bean.site)

        detail.setText(StringUtils.getDetail(bean.site))
...
//    fun delete(){
//        ApiManager.getInstance().getApiAddress().deleteAddress(bean.id).enqueue(object :
//            Callback<OperateAddressBean> {
//            override fun onResponse(
//                call: Call<OperateAddressBean>,
//                response: Response<OperateAddressBean>
//            ) {
//                val data = response.body()
//                if (data?.statusCode == 0){
//                    DialogUtil.toast(this@ModifyAddressActivityV2,"删除成功")
//                    finish()
//                }
//            }
//
//            override fun onFailure(call: Call<OperateAddressBean>, t: Throwable) {
//
//            }
//
//        })
//    }
    ...
    fun mofidy(){
        ...
        ApiManager.getInstance().getApiAddress().modifyAddress(
            ...
            phone.text.toString(),
            address + "," + detail.text.toString(),default,bean.id).enqueue(object :
            Callback<OperateAddressBean> {
            override fun onResponse(
                call: Call<OperateAddressBean>,
                response: Response<OperateAddressBean>
                ...
                if (response.body()!= null){
                    ...
                    if (body?.statusCode == 0){
                        DialogUtil.toast(this@ModifyAddressActivityV2,"修改成功")
                        finish()
                    }
                }
            }
