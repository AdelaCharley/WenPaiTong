...
import kotlinx.android.synthetic.main.activity_account_safty.*
...
class AccountSaftyActivity : BaseActivity() {
                ...
                override fun onResponse(call: Call<ResponseBody>,
                    ...
                    if (json.getInt("status") == 0) {
                        ...
                        layout_auth.setOnClickListener {
                            val intent = Intent(this@AccountSaftyActivity, AuthInfoActivity::class.java)
                            val gson = Gson()
                        ...
                        authstatus.setText("未实名")
                        authstatus.setTextColor(resources.getColor(R.color.red))
                        layout_auth.setOnClickListener {
                            val intent =
                                Intent(this@AccountSaftyActivity, WenBanTongAuthActivity::class.java)
    ...
    fun initView() {
        ...
        layout_zhuxiao.setOnClickListener {
            ...
            ApiManager.getInstance().getApiPersonalTest().loadLogOutStatus(UserInfoViewModel.getUserId()).enqueue(object :
                Callback<LogOutStatusBean> {
                override fun onResponse(
                    ...
                    if (response.body()!!.code == 200){
                        when(response.body()!!.data.status){
                            0 -> {
                                val intent =
                                    Intent(this@AccountSaftyActivity, ApplyLogoutActivity::class.java)
                                startActivity(intent)
                            }
                            10 -> {
                                val intent =
                                    Intent(this@AccountSaftyActivity, ApplyLogoutingActivity::class.java)
                                startActivity(intent)
                            }
                            20 -> {
                                val intent =
                                    Intent(this@AccountSaftyActivity, ApplyLogOutFailedActivity::class.java)
    ...
    fun uploadImage(imagePath: String) {
        ...
        com.qunshang.wenpaitong.equnshang.utils.ImageUtil.uploadImage(
                        ...
                        .enqueue(object: Callback<UserMsgBean> {
                            override fun onResponse(call: Call<UserMsgBean>,
                                ...
                                Log.i("zhangjuniii",
                                    UserInfoViewModel.getUserInfo()!!.headimage)
                                if (response.body() == null) {
                                    DialogUtil.toast(this@AccountSaftyActivity, "出错了")
                                }
                                if (response.body()!!.code == 200) {
                    ...
                    ApiManager.getInstance().getApiPersonalTest().updatePersonalData(
                        ...
                        .enqueue(object: Callback<UserMsgBean> {
                            override fun onResponse(call: Call<UserMsgBean>,
                                ...
                                if (response.body()!!.code == 200) {
                                    DialogUtil.toast(this@AccountSaftyActivity,"修改成功")
                                    username.setText(inputStr)
                                    UserInfoViewModel.getUserInfo()?.uname = inputStr
                                } else {
                                    DialogUtil.toast(this@AccountSaftyActivity,"修改失败")
                                }
                            }
        ...
        runOnUiThread {
            ...
            ApiManager.getInstance().getApiPersonalTest().updatePersonalData(
                ...
                override fun onResponse(call: Call<UserMsgBean>, response: Response<UserMsgBean>) {
                    ...
                    if (response.body()?.code == 200) {
                        Glide.with(this@AccountSaftyActivity).load(response.body()?.data!!.headimage)
                            .into(userimage)
                        UserInfoViewModel.getUserInfo()?.headimage =
