...
import com.qunshang.wenpaitong.equnshang.utils.AnimUtils
import java.util.*
...
class LikeView : RelativeLayout {
    ...
    private var onLikeListener: OnLikeListener? = object : OnLikeListener {
    ...
    private fun addLikeView(e: MotionEvent) {
        ...
        imageView.setImageResource(R.mipmap.btn_main_like_true)
        addView(imageView)
