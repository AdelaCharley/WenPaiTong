...
import kotlinx.android.synthetic.main.dialog_bmall_product.*
import org.greenrobot.eventbus.EventBus
import org.greenrobot.eventbus.Subscribe
import org.greenrobot.eventbus.ThreadMode
import com.qunshang.wenpaitong.equnshang.utils.DialogUtil

class BMallProductsDialog(val type : String,val bean : com.qunshang.wenpaitong.equnshang.data.ProductBean) : BaseBottomSheetDialog() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater.inflate(R.layout.dialog_bmall_product,container)
    }
