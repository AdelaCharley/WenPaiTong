...
class CollegeShare_OneFragment(val bean : CollegeNewsShareBean) : BaseShareFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_college_share__one, container, false)
    }
