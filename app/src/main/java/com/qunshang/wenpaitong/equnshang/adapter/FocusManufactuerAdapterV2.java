...
import com.qunshang.wenpaitong.equnshang.activity.StoreDetailActivityV2;
...
public class FocusManufactuerAdapterV2 extends RecyclerView.Adapter<FocusManufactuerAdapterV2.ViewHolder> {
    ...
    public FocusManufactuerAdapterV2(Context context,List<FocusManufactuerBean.DataBean> data){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_focus_manufactuerv2,parent,false));
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.layout.setOnClickListener(v -> {
            Intent intent = new Intent(context, StoreDetailActivityV2.class);
