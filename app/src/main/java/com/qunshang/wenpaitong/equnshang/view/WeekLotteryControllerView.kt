...
import kotlinx.android.synthetic.main.view_controller_week_lottery.view.layout_brand
import kotlinx.android.synthetic.main.view_controller_week_lottery.view.layout_lottery
 ...
 */
class WeekLotteryControllerView(context: Context?, attrs: AttributeSet?) : RelativeLayout(context, attrs), View.OnClickListener {
    ...
    init {
        val rootView = LayoutInflater.from(context).inflate(R.layout.view_controller_week_lottery, this)
