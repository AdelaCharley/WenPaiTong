...
public class SkuDialogAdapterV3 extends RecyclerView.Adapter<SkuDialogAdapterV3.ViewHolder> {

    public List<ProductBean.DataBean.SpecList> data;
    ...
    public SkuDialogAdapterV3(Context context,List<ProductBean.DataBean.SpecList> data){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_sku_dialog_v3,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ProductBean.DataBean.SpecList spec = data.get(position);
        //holder.text.setText(data.get(position).getValue());
        holder.skuname.setText(spec.getName());
        holder.skus.setAdapter(new SpecDialogAdapterV3(context,spec.getList(),position,data.size()));
