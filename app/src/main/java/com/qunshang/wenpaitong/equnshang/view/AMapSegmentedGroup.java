...
public class AMapSegmentedGroup extends RadioGroup {
    ...
    public AMapSegmentedGroup(Context context) {
        super(context);
    ...
    public AMapSegmentedGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        resources = getResources();
        mTintColor = resources.getColor(R.color.radio_button_selected_color);
        mMarginDp = (int) getResources().getDimension(R.dimen.radio_button_stroke_border);
    ...
    private class LayoutSelector {
        ...
        private int getChildren() {
            return AMapSegmentedGroup.this.getChildCount();
        }

        private int getChildIndex(View view) {
            return AMapSegmentedGroup.this.indexOfChild(view);
        }
