package com.qunshang.wenpaitong.equnshang.view.video;
...
public class MyVodController extends FrameLayout implements IControlComponent, View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    public MyVodController(@NonNull Context context) {
        super(context);
    }

    public MyVodController(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MyVodController(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...

    {
        ...
        mBottomContainer = findViewById(xyz.doikki.videocontroller.R.id.bottom_container);
        mVideoProgress = findViewById(xyz.doikki.videocontroller.R.id.seekBar);
        mVideoProgress.setOnSeekBarChangeListener(this);
        mTotalTime = findViewById(xyz.doikki.videocontroller.R.id.total_time);
        mCurrTime = findViewById(xyz.doikki.videocontroller.R.id.curr_time);
    ...
    protected int getLayoutId() {
        return xyz.doikki.videocontroller.R.layout.dkplayer_layout_vod_control_view;
    }
